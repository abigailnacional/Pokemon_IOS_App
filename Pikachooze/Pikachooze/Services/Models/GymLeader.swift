...
extension GymLeader{
    static let previewData = [
        ...
        GymLeader(id: "7", name: "Blaine", image: URL(string:"https://archives.bulbagarden.net/media/upload/c/c8/Lets_Go_Pikachu_Eevee_Blaine.png")!, gymBadge: URL(string:"https://archives.bulbagarden.net/media/upload/thumb/1/12/Volcano_Badge.png/1200px-Volcano_Badge.png")!,
            gymPokemon:[
