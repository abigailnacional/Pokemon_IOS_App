...
extension GymLeader{
    static let previewData = [
        GymLeader(id: "1", name: "Brock", image: URL(string:"https://archives.bulbagarden.net/media/upload/thumb/a/a6/Lets_Go_Pikachu_Eevee_Brock.png/243px-Lets_Go_Pikachu_Eevee_Brock.png")! , city: "Pewter City", gymBadge:URL(string:"https://archives.bulbagarden.net/media/upload/thumb/d/dd/Boulder_Badge.png/1200px-Boulder_Badge.png")!,
            gymPokemon:[
        ...
        GymLeader(id: "2", name: "Misty", image: URL(string:"https://archives.bulbagarden.net/media/upload/f/f6/Lets_Go_Pikachu_Eevee_Misty.png")!, city: "Cerulean City", gymBadge: URL(string:"https://archives.bulbagarden.net/media/upload/9/9c/Cascade_Badge.png")!,
            gymPokemon:[
        ...
        GymLeader(id: "3", name: "Lt. Surge", image: URL(string:"https://archives.bulbagarden.net/media/upload/thumb/b/bc/Lets_Go_Pikachu_Eevee_Lt_Surge.png/866px-Lets_Go_Pikachu_Eevee_Lt_Surge.png")!, city: "Vermilion City", gymBadge: URL(string:"https://archives.bulbagarden.net/media/upload/thumb/a/a6/Thunder_Badge.png/1200px-Thunder_Badge.png")!,
            gymPokemon:[
        ...
        GymLeader(id: "4", name: "Erika", image: URL(string:"https://archives.bulbagarden.net/media/upload/thumb/4/47/Lets_Go_Pikachu_Eevee_Erika.png/487px-Lets_Go_Pikachu_Eevee_Erika.png")!, city: "Celadon City", gymBadge: URL(string:"https://archives.bulbagarden.net/media/upload/thumb/b/b5/Rainbow_Badge.png/1200px-Rainbow_Badge.png")!,
            gymPokemon:[
        ...
        GymLeader(id: "5", name: "Koga", image: URL(string:"https://archives.bulbagarden.net/media/upload/f/f4/Lets_Go_Pikachu_Eevee_Koga.png")!, city: "Fuchsia City", gymBadge: URL(string:"https://archives.bulbagarden.net/media/upload/thumb/7/7d/Soul_Badge.png/1200px-Soul_Badge.png")!,
            gymPokemon:[
        ...
        GymLeader(id: "6", name: "Sabrina", image: URL(string:"https://archives.bulbagarden.net/media/upload/7/78/Lets_Go_Pikachu_Eevee_Sabrina.png")!, city: "Saffron City", gymBadge: URL(string:"https://archives.bulbagarden.net/media/upload/thumb/6/6b/Marsh_Badge.png/1200px-Marsh_Badge.png")!,
            gymPokemon:[
        ...
        GymLeader(id: "7", name: "Blaine", image: URL(string:"https://archives.bulbagarden.net/media/upload/c/c8/Lets_Go_Pikachu_Eevee_Blaine.png")!, city: "Cinnabar Island", gymBadge: URL(string:"https://archives.bulbagarden.net/media/upload/thumb/1/12/Volcano_Badge.png/1200px-Volcano_Badge.png")!,
            gymPokemon:[
        ...
        GymLeader(id: "8", name: "Giovanni", image: URL(string:"https://archives.bulbagarden.net/media/upload/a/a7/Lets_Go_Pikachu_Eevee_Giovanni.png")!, city: "Viridian City", gymBadge: URL(string:"https://archives.bulbagarden.net/media/upload/thumb/7/78/Earth_Badge.png/1200px-Earth_Badge.png")!,
            gymPokemon:[
