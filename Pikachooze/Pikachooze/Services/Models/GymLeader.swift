...
extension GymLeader{
    static let previewData = [
        ...
        GymLeader(id: "8", name: "Giovanni", image: URL(string:"https://archives.bulbagarden.net/media/upload/a/a7/Lets_Go_Pikachu_Eevee_Giovanni.png")!, gymBadge: URL(string:"https://archives.bulbagarden.net/media/upload/thumb/7/78/Earth_Badge.png/1200px-Earth_Badge.png")!,
            gymPokemon:[
                Pokemon(id: "23", number: "111", name: "Rhyhorn", nickname: "", classification: "Spikes Pokémon", types: ["Ground", "Rock"], resistant: ["Normal", "Fire", "Electric", "Poison", "Flying", "Rock"], weaknesses: ["Water", "Grass", "Ice", "Fighting", "Ground", "Steel"], image: URL(string:"https://img.pokemondb.net/artwork/rhyhorn.jpg, inInventory")!),
